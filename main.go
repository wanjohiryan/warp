...
func getConfig() Config {
	...
	cert := flag.String("tls-cert", "/etc/warp/certs/localhost.crt", "TLS certificate file path")
	key := flag.String("tls-key", "/etc/warp/certs/localhost.key", "TLS certificate file path")
